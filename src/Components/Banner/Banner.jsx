        ...
        <div className='flex lg:h-screen flex-col lg:flex-row gap-2 items-center justify-between'>
          <div data-aos="fade-right" className='w-full lg:w-1/2 py-8 lg:py-0'>
            ...
            <div class="flex flex-wrap justify-center lg:justify-start gap-3 mb-5">
              ...
              <div class="inline-flex items-center rounded-full border text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground px-3 py-1 border-primary/30 hover-glow animate-scale-in">ReactJS</div>
              <div class="inline-flex items-center rounded-full border text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground px-3 py-1 border-primary/30 hover-glow animate-scale-in">NextJS</div>
              <div class="inline-flex items-center rounded-full border text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground px-3 py-1 border-primary/30 hover-glow animate-scale-in">NodeJS</div>
