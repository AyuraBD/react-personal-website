...
const TechStack = () => {
  return (
    <section className="py-6 lg:py-10 px-3 lg:px-6 relative overflow-hidden">
      ...
      <div data-aos="fade-up" className='mb-8 grid grid-cols md:grid-cols-2 lg:grid-cols-4 gap-5'>
      ...
      <div data-aos="fade-up" className="grid md:grid-cols-2 gap-14">
        {/* Expertise */}
        ...
        <div className='p-4 lg:p-6 border border-primary/20 rounded-lg hover:scale-105 hover-glow'>
          ...
          <ul className="space-y-2 text-gray-300 list-none list-inside">
            <li className='flex items-center'><TiTickOutline className='text-2xl text-primary mr-2'></TiTickOutline>Scalable e-commerce systems with backend API integration</li>
            <li className='flex items-center'><TiTickOutline className='text-2xl text-primary mr-2'></TiTickOutline>Animated, responsive frontend interfaces</li>
